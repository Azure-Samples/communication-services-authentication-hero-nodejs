...
1. Navigate to the [Azure portal](https://portal.azure.com), search for and select **Azure AD** service.

2. In the **Azure Active Directory** service page, click on the **App Registrations** menu item on the left, then click on **New registration** on the top bar.

3. In the **Register an application** page that opened, enter your application's registration information:
   ...
   3. Finally, click on the **Register** button to create the application. This will automaticcally open your application page once the registration is sucessful.
...
4. In the app's registration screen (**auther-server-sample-webApi** page), 
   ...
   3. Navigate to and cloick on the **Expose an API** menu item on the left to open the page where you can declare the parameters to expose this app as an API from which client applications can obtain the [access tokens](https://docs.microsoft.com/azure/active-directory/develop/access-tokens).
...
1. Navigate to the [Azure portal](https://portal.azure.com), search and select **Azure AD** service.

2. In the **Azure Active Directory** service page, click on **App Registrations** menu item on the left, then click on **New registration** on the top bar.
...
3. In the **Register an application** page that opens, enter your application's registration information:
   ...
   4. Finally, click on the **Register** button to create the application. This will automaticcally open your application page once the registration is sucessful.
...
4. In the app's registration screen (**auther-server-sample-webClient** page), 
   ...
   2. Navigate to and click on **API permissions** menu item on the left to open the page where access to the APIs needed by your application will be defined.
      ...
      5. Click on the **Add permissions** button at the bottom.

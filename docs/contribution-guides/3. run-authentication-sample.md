...
> Note: 
>
> 1. This client app registration will be used to manually generate the Azure AD Token required to call Azure AD protected Web API unless the sample client is being used with a Single Page App registered.
